...
public class LineChart extends HighCharts {
  ...
  public void hoverOverGraphPointAtXAxisPosition(int pointNumber) {
    int xRect = ((Locatable) rectElement).getCoordinates().getLocationOnScreen().getX();
    int yRect = ((Locatable) rectElement).getCoordinates().getLocationOnScreen().getY();
    ...
    xHoverPoint = xHoverPoint - ((Locatable) elementToHoverOver).getCoordinates().getLocationOnScreen().getX();
    yHoverPoint = yHoverPoint - ((Locatable) elementToHoverOver).getCoordinates().getLocationOnScreen().getY();
